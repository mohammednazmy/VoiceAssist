...
slug: releases/v4.1.1
summary: Patch release with test suite stability fixes and HuggingFace security hardening.
status: stable
...
version: v4.1.1
ai_summary: >-
  Voice Mode v4.1.1 patch release. Bug fixes: resolved 8 failing tests (41/41 passing).
  Security: HuggingFace model revision pinning (Bandit B615) for PHI NER, diarization,
  and medical embedding models. Medium-severity issues reduced from 16 to 6.
---
