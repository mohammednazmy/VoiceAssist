...
slug: releases/v4.1.2
summary: Feature release with EnhancedG2PService and expanded multi-language lexicon (1,384 entries).
status: stable
...
version: v4.1.2
ai_summary: >-
  Voice Mode v4.1.2 feature release. New EnhancedG2PService with 5-source fallback chain:
  medical cache (50+ terms), CMUdict (134k words), gruut (multi-language), espeak-ng,
  and raw fallback. Lexicon expanded to 1,384 pronunciation entries. Supports English,
  German, French, Spanish, Russian, Polish, Arabic, and CJK.
---
