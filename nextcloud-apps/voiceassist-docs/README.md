...
- Not packaged or installed automatically
- Provided so that:
  - the file structure is in place
  - documentation references have concrete targets
  - future phases can flesh out real functionality
