...
@pytest.mark.skip(reason="Provider verification requires pact files from consumer tests")
def test_verify_pact_with_provider():
    ...
    Note: This test requires pact files generated by consumer tests.
    In CI, run consumer tests first to generate pacts, then run
    provider verification separately.
