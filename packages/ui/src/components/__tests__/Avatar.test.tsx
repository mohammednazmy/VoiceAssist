...
describe('Avatar', () => {
  describe('Rendering', () => {
    ...
    it('renders all sizes correctly', () => {
      ...
      sizes.forEach((size) => {
        const { rerender, container } = render(<Avatar size={size} alt={size} />);
  ...
  describe('Accessibility', () => {
    it('has alt text on image', () => {
      render(<Avatar src="https://example.com/avatar.jpg" alt="John Doe" />);
      expect(screen.getByRole('img', { hidden: true })).toHaveAttribute('alt', 'John Doe');
    });
  ...
  describe('Custom className', () => {
    it('merges custom className with default classes', () => {
      const { container } = render(<Avatar className="custom-class" alt="Test" />);
      const avatar = container.firstChild as HTMLElement;
