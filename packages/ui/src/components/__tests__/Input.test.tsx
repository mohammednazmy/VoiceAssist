...
describe('Input', () => {
  describe('Rendering', () => {
    ...
    it('renders all sizes correctly', () => {
      ...
      sizes.forEach((size) => {
        const { rerender } = render(<Input inputSize={size} placeholder={size} />);
  ...
  describe('Error State', () => {
    ...
    it('associates error message with input using aria-describedby', () => {
      ...
      expect(document.getElementById(errorMessageId!)).toHaveTextContent('Error message');
    });
    ...
    it('shows error message instead of helper text when both provided', () => {
      render(
        <Input error errorMessage="Error" helperText="Helper" />
      );
  ...
  describe('Value Control', () => {
    it('works as controlled component', async () => {
      ...
      const input = container.querySelector('[data-testid="controlled-input"]') as HTMLInputElement;
