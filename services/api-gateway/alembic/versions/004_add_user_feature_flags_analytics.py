...
def upgrade():
    ...
    op.add_column(
        "feature_flags",
        sa.Column("rollout_percentage", sa.Integer, nullable=True, server_default="100"),
    )
    ...
    op.create_index(
        "ix_user_feature_flags_user_flag",
        "user_feature_flags",
        ["user_id", "flag_name"],
        unique=True,
    )
    ...
    op.create_index(
        "ix_feature_flag_analytics_flag_date",
        "feature_flag_analytics",
        ["flag_name", "checked_at"],
    )
    op.create_index(
        "ix_feature_flag_analytics_user_date",
        "feature_flag_analytics",
        ["user_id", "checked_at"],
    )
