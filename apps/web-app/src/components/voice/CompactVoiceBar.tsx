    ...
    >
      ...
      <div className="flex items-center gap-1 flex-shrink-0">
        ...
        <button
          ...
          onClick={() => {
            console.log(
              "[CompactVoiceBar] Settings button clicked via direct button",
            );
            onOpenSettings();
          }}
          className="p-2 text-neutral-600 hover:text-neutral-800 hover:bg-neutral-100 rounded-lg transition-colors bg-amber-100 border border-amber-300"
          aria-label="Voice settings"
          data-testid="compact-settings-btn"
        >
          <svg
            className="w-5 h-5"
            fill="none"
