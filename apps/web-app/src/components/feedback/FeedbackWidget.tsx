    ...
    <div className="fixed bottom-4 right-4 z-40 w-80 max-w-full">
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="mt-3 flex items-center gap-2" role="group" aria-label="Rate your experience">
            <button
              type="button"
          ...
          <label className="mt-3 block text-sm font-medium text-neutral-900 dark:text-neutral-100" htmlFor="feedback-comment">
            Optional comments
          </label>
          <textarea
            id="feedback-comment"
