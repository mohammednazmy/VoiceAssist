...
### AEC Capability Tuning Flag

| Flag | Type | Default | Description |
|------|------|---------|-------------|
| `backend.voice_aec_capability_tuning` | boolean | `false` | When enabled, uses frontend AEC quality (excellent/good/fair/poor/unknown) to make echo-related thresholds more conservative on devices with poor/no AEC. Guards both backend HybridVADDecider tuning and frontend playback-time Silero thresholds. |
