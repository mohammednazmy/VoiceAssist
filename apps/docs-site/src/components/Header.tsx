      ...
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex md:items-center md:gap-6">
          ...
          >
            ...
            <span>Search</span>
            <span className="rounded border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-800 px-1.5 py-0.5 text-[10px] font-medium text-gray-500 dark:text-gray-400">⌘/Ctrl + K</span>
          </button>
        </div>
